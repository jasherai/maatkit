...
OS:           linux
Start:        Fri Jul 31 18:52:46 2009
Finish:       Fri Jul 31 18:52:46 2009
...
17             1                    1             9   use strict;
               1                                  2   
               1                                  8   
18             1                    1             6   use warnings FATAL => 'all';
               1                                  2   
               1                                  9   
19                                                    
...
21                                                    package MockSth;
22                                                    
23             1                    1             6   use constant MKDEBUG => $ENV{MKDEBUG};
               1                                  2   
               1                                 11   
24                                                    
25                                                    sub new {
26             2                    2            17      my ( $class, @rows ) = @_;
27             2                                  9      my $self = {
28                                                          cursor => 0,
29                                                          Active => scalar(@rows),
30                                                          rows   => \@rows,
31                                                       };
32             2                                 21      return bless $self, $class;
33                                                    }
34                                                    
