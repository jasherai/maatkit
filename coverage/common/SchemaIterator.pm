...
---------------------------- ------ ------ ------ ------ ------ ------ ------
.../common/SchemaIterator.pm   95.4   81.8   73.8   92.9    0.0    8.3   86.0
SchemaIterator.t              100.0   50.0   40.0  100.0    n/a   91.7   97.3
...
OS:           linux
Start:        Mon Jan 25 17:16:18 2010
Finish:       Mon Jan 25 17:16:18 2010

Run:          SchemaIterator.t
Perl version: 118.53.46.49.48.46.48
OS:           linux
Start:        Mon Jan 25 17:16:20 2010
Finish:       Mon Jan 25 17:16:21 2010
...
36    ***      1     50                          23         die "I need a $arg argument" unless $args{$arg};
37                                                       }
38             1                                  8      my $self = {
39                                                          %args,
40                                                          filter => undef,
41                                                          dbs    => [],
42                                                       };
43             1                                 15      return bless $self, $class;
44                                                    }
45                                                    
46                                                    # Required args:
...
78                                                    
79    ***     22     50                         116      my @permit_dbs = _make_filter('unless', '$db', $o->get('databases'))
80                                                          if $o->has('databases');
81    ***     22     50                         116      my @reject_dbs = _make_filter('if', '$db', $o->get('ignore-databases'))
82                                                          if $o->has('ignore-databases');
83            22                                 70      my @dbs_regex;
84    ***     22    100     66                  116      if ( $o->has('databases-regex') && (my $p = $o->get('databases-regex')) ) {
85             1                                  9         push @dbs_regex, "      return 0 unless \$db && (\$db =~ m/$p/o);";
86                                                       }
87            22                                 69      my @reject_dbs_regex;
88    ***     22    100     66                  109      if ( $o->has('ignore-databases-regex')
89                                                            && (my $p = $o->get('ignore-databases-regex')) ) {
90             1                                  9         push @reject_dbs_regex, "      return 0 if \$db && (\$db =~ m/$p/o);";
91                                                       }
92            22    100    100                  320      if ( @permit_dbs || @reject_dbs || @dbs_regex || @reject_dbs_regex ) {
                           100                        
                           100                        
...
100                                                      }
101                                                   
102   ***     22     50     33                  113      if ( $o->has('tables') || $o->has('ignore-tables')
      ***                   33                        
...
107           22                                539         my $have_qtbl       = 0;
108           22                                 64         my $have_only_qtbls = 0;
109           22                                 62         my %qtbls;
110                                                   
111           22                                 56         my @permit_tbls;
112           22                                 50         my @permit_qtbls;
113           22                                 61         my %permit_qtbls;
114           22    100                         104         if ( $o->get('tables') ) {
115            9                                237            my %tbls;
116                                                            map {
117           13    100                         263               if ( $_ =~ m/\./ ) {
               9                                 42   
118                                                                  # Table is db-qualified (db.tbl).
119           12                                 57                  $permit_qtbls{$_} = 1;
120                                                               }
121                                                               else {
122            1                                  6                  $tbls{$_} = 1;
123                                                               }
124            9                                 29            } keys %{ $o->get('tables') };
125            9                                 48            @permit_tbls  = _make_filter('unless', '$tbl', \%tbls);
126            9                                 42            @permit_qtbls = _make_filter('unless', '$qtbl', \%permit_qtbls);
127                                                   
128            9    100                          44            if ( @permit_qtbls ) {
129            8                                 29               push @lines,
130                                                                  '   my $qtbl   = ($db ? "$db." : "") . ($tbl ? $tbl : "");';
131            8                                 33               $have_qtbl = 1;
132                                                            }
133                                                         }
134                                                   
135           22                                393         my @reject_tbls;
136           22                                 59         my @reject_qtbls;
137           22                                 59         my %reject_qtbls;
138   ***     22     50                         109         if ( $o->get('ignore-tables') ) {
139           22                                583            my %tbls;
140                                                            map {
141            5    100                          99               if ( $_ =~ m/\./ ) {
              22                                100   
...
146            4                                 16                  $tbls{$_} = 1;
147                                                               }
148           22                                 70            } keys %{ $o->get('ignore-tables') };
149           22                                550            @reject_tbls= _make_filter('if', '$tbl', \%tbls);
150           22                                110            @reject_qtbls = _make_filter('if', '$qtbl', \%reject_qtbls);
151                                                   
152   ***     22    100     66                  135            if ( @reject_qtbls && !$have_qtbl ) {
153            1                                  4               push @lines,
...
162           22    100    100                  167         if ( keys %permit_qtbls  && !@permit_dbs ) {
163            3                                 13            my $dbs = {};
164            5                                 32            map {
165            3                                 13               my ($db, undef) = split(/\./, $_);
166            5                                 27               $dbs->{$db} = 1;
167                                                            } keys %permit_qtbls;
168            3                                 10            MKDEBUG && _d('Adding restriction "--databases',
169                                                                  (join(',', keys %$dbs) . '"'));
170   ***      3     50                          20            if ( keys %$dbs ) {
171                                                               # Only recurse if extracting the dbs worked. Else, the
172                                                               # following code will still work and we just lose this
173                                                               # optimization.
174            3                                 24               $o->set('databases', $dbs);
175            3                                123               return $self->make_filter($o);
176                                                            }
177                                                         }
178                                                   
179           19                                 54         my @tbls_regex;
180   ***     19    100     66                   97         if ( $o->has('tables-regex') && (my $p = $o->get('tables-regex')) ) {
181            1                                  7            push @tbls_regex, "      return 0 unless \$tbl && (\$tbl =~ m/$p/o);";
182                                                         }
183           19                                 58         my @reject_tbls_regex;
184   ***     19    100     66                   87         if ( $o->has('ignore-tables-regex')
185                                                              && (my $p = $o->get('ignore-tables-regex')) ) {
186            1                                  8            push @reject_tbls_regex,
187                                                               "      return 0 if \$tbl && (\$tbl =~ m/$p/o);";
188                                                         }
189                                                   
190           19                                 57         my @get_eng;
191           19                                 47         my @permit_engs;
192           19                                 47         my @reject_engs;
193   ***     19     50     66                   91         if ( ($o->has('engines') && $o->get('engines'))
      ***                   33                        
      ***                   66                        
194                                                              || ($o->has('ignore-engines') && $o->get('ignore-engines')) ) {
195           19                                138            push @get_eng,
...
208                                                            @reject_engs
209           19                                114               = _make_filter('if', '$engine', $o->get('ignore-engines'), 1)
210                                                         }
211                                                   
212   ***     19     50    100                  471         if ( @permit_tbls || @reject_tbls || @tbls_regex || @reject_tbls_regex
                           100                        
                           100                        
                           100                        
      ***                   66                        
213                                                              || @permit_engs || @reject_engs ) {
214           19    100                         358            push @lines,
                    100                               
                    100                               
                    100                               
                    100                               
...
250                                                   sub set_filter {
251   ***     19                   19      0     91      my ( $self, $filter_sub ) = @_;
252           19                                 89      $self->{filter} = $filter_sub;
253           19                                532      MKDEBUG && _d('Set filter sub');
254           19                                 86      return;
255                                                   }
256                                                   
257                                                   # Required args:
...
263                                                   sub get_db_itr {
264   ***     13                   13      0    116      my ( $self, %args ) = @_;
265           13                                 70      my @required_args = qw(dbh);
266           13                                 66      foreach my $arg ( @required_args ) {
267   ***     13     50                          98         die "I need a $arg argument" unless $args{$arg};
268                                                      }
269           13                                 65      my ($dbh) = @args{@required_args};
270                                                   
271           13                                 53      my $filter = $self->{filter};
272           13                                 44      my @dbs;
273           13                                 38      eval {
274           13                                 48         my $sql = 'SHOW DATABASES';
275           13                                 34         MKDEBUG && _d($sql);
276           78    100                        7634         @dbs =  grep {
277           13                                 45            my $ok = $filter ? $filter->($dbh, $_, undef) : 1;
278           78    100                         477            $ok = 0 if $_ =~ m/information_schema|lost\+found/;
279           78                                295            $ok;
280           13                                 45         } @{ $dbh->selectcol_arrayref($sql) };
281           13                                 63         MKDEBUG && _d('Found', scalar @dbs, 'databases');
282                                                      };
283           13                                 32      MKDEBUG && $EVAL_ERROR && _d($EVAL_ERROR);
284                                                      return sub {
285           42                   42           281         return shift @dbs;
286           13                                139      };
287                                                   }
288                                                   
289                                                   # Required args:
...
300                                                   sub get_tbl_itr {
301   ***     26                   26      0    219      my ( $self, %args ) = @_;
302           26                                140      my @required_args = qw(dbh db);
303           26                                116      foreach my $arg ( @required_args ) {
304   ***     52     50                         300         die "I need a $arg argument" unless $args{$arg};
305                                                      }
306           26                                193      my ($dbh, $db, $views) = @args{@required_args, 'views'};
307                                                   
308           26                                144      my $filter = $self->{filter};
309           26                                 79      my @tbls;
310   ***     26     50                         113      if ( $db ) {
311           26                                 80         eval {
312           26                                221            my $sql = 'SHOW /*!50002 FULL*/ TABLES FROM '
313                                                                    . $self->{Quoter}->quote($db);
314           26                                937            MKDEBUG && _d($sql);
315           72                                364            @tbls = map {
316          102                               8231               $_->[0]
317                                                            }
318                                                            grep {
319           26                                 74               my ($tbl, $type) = @$_;
320          102    100                         637               my $ok = $filter ? $filter->($dbh, $db, $tbl) : 1;
321          102    100                         467               if ( !$views ) {
...
328                                                                  # no $type.
329   ***     79    100     50                  643                  $ok = 0 if ($type || '') eq 'VIEW';
330                                                               }
331          102                                355               $ok;
332                                                            }
333           26                                 89            @{ $dbh->selectall_arrayref($sql) };
334           26                                992            MKDEBUG && _d('Found', scalar @tbls, 'tables in', $db);
335                                                         };
336           26                                 84         MKDEBUG && $EVAL_ERROR && _d($EVAL_ERROR);
337                                                      }
338                                                      else {
339   ***      0                                  0         MKDEBUG && _d('No db given so no tables');
340                                                      }
341                                                      return sub {
342           98                   98           614         return shift @tbls;
343           26                                321      };
344                                                   }
345                                                   
346                                                   # Required args:
...
356          144                  144          1559      my ( $cond, $var_name, $objs, $lc ) = @_;
357          144                                397      my @lines;
358          144    100                         764      if ( scalar keys %$objs ) {
359           75    100                         491         my $test = join(' || ',
360           44                                194            map { "$var_name eq '" . ($lc ? lc $_ : $_) ."'" } keys %$objs);
361           44                                267         push @lines, "      return 0 $cond $var_name && ($test);",
362                                                      }
363          144                                829      return @lines;
364                                                   }
365                                                   
366                                                   sub _d {
...
11             1                    1            11   use English qw(-no_match_vars);
               1                                  3   
               1                                  8   
12             1                    1             9   use Test::More tests => 34;
               1                                  2   
               1                                 10   
13                                                    
14             1                    1             7   use List::Util qw(max);
               1                                  2   
               1                                 11   
15                                                    
16             1                    1            12   use SchemaIterator;
               1                                  3   
               1                                 11   
17             1                    1            11   use Quoter;
               1                                  3   
               1                                 10   
18             1                    1             9   use DSNParser;
               1                                  3   
               1                                 14   
19             1                    1            15   use Sandbox;
               1                                  3   
               1                                 10   
20             1                    1            10   use OptionParser;
               1                                  2   
               1                                 15   
...
27             1                                  3   $Data::Dumper::Sortkeys  = 1;
28             1                                  4   $Data::Dumper::Quotekeys = 0;
29                                                    
30             1                                  8   my $q   = new Quoter();
31             1                                 33   my $dp  = new DSNParser();
32             1                                 78   my $sb  = new Sandbox(basedir => '/tmp', DSNParser => $dp);
33    ***      1     50                          54   my $dbh = $sb->get_dbh_for('master')
34                                                       or BAIL_OUT('Cannot connect to sandbox master');
35             1                                  7   $dbh->{FetchHashKeyName} = 'NAME_lc';
36                                                    
37             1                                 13   my $si = new SchemaIterator(
38                                                       Quoter        => $q,
39                                                    );
40             1                                  7   isa_ok($si, 'SchemaIterator');
41                                                    
42                                                    sub get_all {
43            24                   24           120      my ( $itr ) = @_;
44            24                                 84      my @objs;
45            24                                124      while ( my $obj = $itr->() ) {
46            83                                195         MKDEBUG && SchemaIterator::_d('Iterator returned', Dumper($obj));
47            83                                480         push @objs, $obj;
48                                                       }
49            24                                175      @objs = sort @objs;
50            24                                265      return \@objs;
51                                                    }
52                                                    
53                                                    sub get_all_db_tbls {
54             6                    6            27      my ( $dbh, $si ) = @_;
55             6                                 17      my @db_tbls;
56             6                                 35      my $next_db = $si->get_db_itr(dbh=>$dbh);
57             6                                 31      while ( my $db = $next_db->() ) {
58             9                                 60         my $next_tbl = $si->get_tbl_itr(
59                                                             dbh   => $dbh,
60                                                             db    => $db,
61                                                             views => 0,
62                                                          );
63             9                                 44         while ( my $tbl = $next_tbl->() ) {
64             9                                 57            push @db_tbls, "$db.$tbl";
65                                                          }
66                                                       }
67             6                                 79      return \@db_tbls;
68                                                    }
69                                                    
70                                                    # ###########################################################################
...
75             1                             405380   my @dbs = sort grep { $_ !~ m/information_schema|lost\+found/; } map { $_->[0] } @{ $dbh->selectall_arrayref('show databases') };
               6                                 80   
               6                                689   
               1                                  8   
76                                                    
77             1                                 84   my $next_db = $si->get_db_itr(dbh=>$dbh);
78             1                                 26   is(
79                                                       ref $next_db,
80                                                       'CODE',
...
92                                                    # ###########################################################################
93                                                    
94             1                                 27   my $next_tbl = $si->get_tbl_itr(dbh=>$dbh, db=>'d1');
95             1                                 12   is(
96                                                       ref $next_tbl,
97                                                       'CODE',
...
105                                                   );
106                                                   
107            1                                 20   $next_tbl = $si->get_tbl_itr(dbh=>$dbh, db=>'d2');
108            1                                 14   is_deeply(
...
112                                                   );
113                                                   
114            1                                 20   $next_tbl = $si->get_tbl_itr(dbh=>$dbh, db=>'d3');
115            1                                 13   is_deeply(
...
124                                                   # #############################################################################
125            1                                 30   my $o = new OptionParser(
126                                                      description => 'SchemaIterator'
127                                                   );
128            1                                254   $o->get_specs("$trunk/mk-parallel-dump/mk-parallel-dump");
129            1                               9490   $o->get_opts();
130                                                   
131            1                              17114   my $filter = $si->make_filter($o);
132            1                                 13   is(
133                                                      ref $filter,
134                                                      'CODE',
...
139                                                   
140            1                                  9   $next_db = $si->get_db_itr(dbh=>$dbh);
141            1                                 11   is_deeply(
142                                                      get_all($next_db),
143                                                      \@dbs,
...
155            1                                 20   @ARGV=qw(--d d1);
156            1                                 12   $o->get_opts();
157            1                               1712   $si->set_filter($si->make_filter($o));
158                                                   
159            1                                  6   $next_db = $si->get_db_itr(dbh=>$dbh);
160            1                                  9   is_deeply(
161                                                      get_all($next_db),
162                                                      ['d1'],
163                                                      '--databases'
164                                                   );
165                                                   
166            1                                 12   $next_tbl = $si->get_tbl_itr(dbh=>$dbh, db=>'d1');
167            1                                  9   is_deeply(
...
175            1                                  8   $o->get_opts();
176            1                               1813   $si->set_filter($si->make_filter($o));
177                                                   
178            1                                  7   $next_tbl = $si->get_tbl_itr(dbh=>$dbh, db=>'d1');
179            1                                  9   is_deeply(
...
186            1                                 11   @ARGV=('--ignore-databases', 'mysql,sakila,d1,d3');
187            1                                  7   $o->get_opts();
188            1                               1672   $si->set_filter($si->make_filter($o));
189                                                   
190            1                                  6   $next_db = $si->get_db_itr(dbh=>$dbh);
191            1                                  8   is_deeply(
192                                                      get_all($next_db),
193                                                      ['d2'],
...
195                                                   );
196                                                   
197            1                                 15   $next_tbl = $si->get_tbl_itr(dbh=>$dbh, db=>'d2');
198            1                                  8   is_deeply(
...
206            1                                  7   $o->get_opts();
207            1                               1699   $si->set_filter($si->make_filter($o));
208                                                   
209            1                                  7   $next_tbl = $si->get_tbl_itr(dbh=>$dbh, db=>'d1');
210            1                                 10   is_deeply(
...
217            1                                 12   @ARGV=('-d', 'd1', '--ignore-tables', 't1,t3');
218            1                                  7   $o->get_opts();
219            1                               1684   $si->set_filter($si->make_filter($o));
220                                                   
221            1                                  6   $next_tbl = $si->get_tbl_itr(dbh=>$dbh, db=>'d1');
222            1                                  8   is_deeply(
...
229            1                                 11   @ARGV=qw(--engines InnoDB);
230            1                                  7   $o->get_opts();
231            1                               1670   $si->set_filter($si->make_filter($o));
232                                                   
233            1                                 11   $next_db = $si->get_db_itr(dbh=>$dbh);
234            1                                  9   is_deeply(
235                                                      get_all($next_db),
236                                                      \@dbs,
...
238                                                   );
239                                                   
240            1                                 13   $next_tbl = $si->get_tbl_itr(dbh=>$dbh, db=>'d1');
241            1                                 10   is_deeply(
...
245                                                   );
246                                                   
247            1                                 10   @ARGV=qw(--ignore-engines MEMORY);
248            1                                  9   $o->get_opts();
249            1                               1673   $si->set_filter($si->make_filter($o));
250                                                   
251            1                                  7   $next_tbl = $si->get_tbl_itr(dbh=>$dbh, db=>'d1');
252            1                                  9   is_deeply(
...
260                                                   # ###########################################################################
261            1                                  3   SKIP: {
262            1                                  9      skip 'Sandbox master does not have the sakila database', 2
263   ***      1     50                           3         unless @{$dbh->selectcol_arrayref('SHOW DATABASES LIKE "sakila"')};
264                                                   
265            1                                358      my @sakila_tbls = map { $_->[0] } grep { $_->[1] eq 'BASE TABLE' } @{ $dbh->selectall_arrayref('show /*!50002 FULL*/ tables from sakila') };
              16                                 60   
              23                                503   
               1                                  2   
266                                                   
267            1                                 25      my @all_sakila_tbls = map { $_->[0] } @{ $dbh->selectall_arrayref('show /*!50002 FULL*/ tables from sakila') };
              23                                455   
               1                                  2   
268                                                   
269            1                                 23      @ARGV=();
270            1                                  8      $o->get_opts();
271            1                               8433      $si->set_filter($si->make_filter($o));
272                                                   
...
278                                                      );
279                                                   
280            1                                 14      $next_tbl = $si->get_tbl_itr(dbh=>$dbh, db=>'sakila', views=>1);
281            1                                 12      is_deeply(
...
293                                                   
294            1                                 28   @ARGV=qw(--engines InNoDb);
295            1                                 10   $o->get_opts();
296            1                               2023   $si->set_filter($si->make_filter($o));
297            1                                  8   $next_tbl = $si->get_tbl_itr(dbh=>$dbh, db=>'d1');
298            1                                 10   is_deeply(
...
302                                                   );
303                                                   
304            1                                 12   @ARGV=qw(--ignore-engines InNoDb);
305            1                                 10   $o->get_opts();
306            1                               2049   $si->set_filter($si->make_filter($o));
307            1                                  8   $next_tbl = $si->get_tbl_itr(dbh=>$dbh, db=>'d1');
308            1                                  9   is_deeply(
...
315                                                   # Filter by regex.
316                                                   # ###########################################################################
317            1                                 13   @ARGV=qw(--databases-regex d[13] --tables-regex t[^3]);
318            1                                  9   $o->get_opts();
319            1                               2519   $si->set_filter($si->make_filter($o));
320                                                   
321            1                                  8   $next_db = $si->get_db_itr(dbh=>$dbh);
322            1                                 11   is_deeply(
323                                                      get_all($next_db),
324                                                      [qw(d1 d3)],
325                                                      '--databases-regex'
326                                                   );
327                                                   
328            1                                 18   $next_tbl = $si->get_tbl_itr(dbh=>$dbh, db=>'d1');
329            1                                 12   is_deeply(
...
337            1                                 10   $o->get_opts();
338            1                               2544   $si->set_filter($si->make_filter($o));
339                                                   
340            1                                  7   $next_db = $si->get_db_itr(dbh=>$dbh);
341            1                                 10   is_deeply(
342                                                      get_all($next_db),
343                                                      ['d1'],
...
345                                                   );
346                                                   
347            1                                 18   $next_tbl = $si->get_tbl_itr(dbh=>$dbh, db=>'d1');
348            1                                 13   is_deeply(
...
361            1                                 15   @ARGV=qw(-t d1.t1);
362            1                                 10   $o->get_opts();
363            1                               3881   $si->set_filter($si->make_filter($o));
364                                                   
365            1                                 11   is_deeply(
...
369                                                   );
370                                                   
371            1                                 16   @ARGV=qw(-d d1 -t d1.t1);
372            1                                  9   $o->get_opts();
373            1                               1705   $si->set_filter($si->make_filter($o));
374                                                   
375            1                                  5   is_deeply(
...
379                                                   );
380                                                   
381            1                                 11   @ARGV=qw(-d d2 -t d1.t1);
382            1                                  8   $o->get_opts();
383            1                               1707   $si->set_filter($si->make_filter($o));
384                                                   
385            1                                  5   is_deeply(
...
389                                                   );
390                                                   
391            1                                 11   @ARGV=('-t','d1.t1,d1.t3');
392            1                                  8   $o->get_opts();
393            1                               1713   $si->set_filter($si->make_filter($o));
394                                                   
395            1                                  5   is_deeply(
...
399                                                   );
400                                                   
401            1                                 12   @ARGV=('--ignore-databases', 'mysql,sakila', '--ignore-tables', 'd1.t2');
402            1                                  8   $o->get_opts();
403            1                               1717   $si->set_filter($si->make_filter($o));
404                                                   
405            1                                  6   is_deeply(
...
409                                                   );
410                                                   
411            1                                 11   @ARGV=('-t','d1.t3,d2.t1');
412            1                                  9   $o->get_opts();
413            1                               1688   $si->set_filter($si->make_filter($o));
414                                                   
415            1                                  6   is_deeply(
