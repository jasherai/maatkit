...
OS:           linux
Start:        Sat Aug 29 15:01:57 2009
Finish:       Sat Aug 29 15:01:58 2009
...
22             1                    1             6   use strict;
               1                                  2   
               1                                  7   
23             1                    1           108   use warnings FATAL => 'all';
               1                                  3   
               1                                  6   
...
44                                                    
45                                                    sub have_priv {
46             3                    3            28      my ( $self, $dbh, $priv ) = @_;
47             3                                 13      $priv = uc $priv;
48             3    100                          21      if ( !exists $check_for_priv{$priv} ) {
49             1                                  3         die "There is no check for privilege $priv";
50                                                       }
51             2                                 18      return $check_for_priv{$priv}->($dbh);
52                                                    }
53                                                    
54                                                    sub _d {
