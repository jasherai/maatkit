...
my $qar = new QueryAdvisorRules(); # Needed to test $qa
my $pp  = new PodParser();         # Needed to load $qar with info from POD
...
$qar->load_rule_info(
   $pp->parse_advisor_rule_info(
      "$ENV{MAATKIT_TRUNK}/mk-query-advisor/mk-query-advisor"));
