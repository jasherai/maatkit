...
like(
   output(qw(../../common/t/samples/recset005.txt --idle-time 15 --print)),
...
$output = `../mk-kill ../../common/t/samples/recset006.txt --match-state Locked  --print --pid /tmp/mk-script.pid 2>&1`;
like(
   $output,
