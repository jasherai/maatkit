mysql> explain select (select count(*) from sakila.film_actor where sakila.film_actor.actor_id = sakila.actor.actor_id) + (select count(*) from sakila.film as f) as count_actors from sakila.actor;
+----+--------------------+------------+-------+---------------+--------------------+---------+----------------+------+--------------------------+
