mysql> explain select (select count(*) + (select count(*) from sakila.film as f) from sakila.film_actor where sakila.film_actor.actor_id = sakila.actor.actor_id) as count_actors from sakila.actor;
+----+--------------------+------------+-------+---------------+--------------------+---------+----------------+------+--------------------------+
