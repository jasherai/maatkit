mysql> explain select * from ( select 1 as foo from sakila.actor as actor_1, sakila.actor as actor_2 ) as x inner join ( select 1 as foo from sakila.actor as actor_3, sakila.actor as actor_4 ) as y using (foo);
+----+-------------+------------+-------+---------------+---------+---------+------+-------+-------------+
